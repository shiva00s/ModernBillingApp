...
public class ProductService
{
    ...
    public async Task ReturnStock(ModernBillingApp.Models.StockReturn returnEntry, int productIdToUpdate)
    {
        ...
        var ledgerEntry = new StockLedger
        {
            ...
            QtyAdded = -(decimal)returnEntry.TQty, // Negative quantity
        ...
        if (product != null)
        {
            product.CurrentStock -= (decimal)returnEntry.TQty; // Subtract stock
        }
    ...
    public async Task<bool> ValidateStockAvailability(int productId, decimal requestedQty)
    {
        var product = await _context.Products.FindAsync(productId);
